...
TABLE_SCHEMA = {
    ...
    'dim_rinkboxcoord': {
        'file': 'dim_rinkboxcoord.csv',
        'primary_key': 'box_id',
        'int_cols': [],  # box_id is text like "O01"
        'float_cols': ['x_min', 'x_max', 'y_min', 'y_max', 'center_x', 'center_y'],
        'order': 30
    },
    'dim_rinkcoordzones': {
        'file': 'dim_rinkcoordzones.csv',
        'primary_key': 'coord_zone_id',
        'int_cols': ['coord_zone_id'],
        'float_cols': ['x_coord', 'y_coord'],
        'order': 31
    },
    'fact_gameroster': {
