...
def create_fact_scoring_chances():
    ...
    scoring_chances = events[events['Type'].isin(['Shot', 'Goal'])].copy()
    
    scoring_chances['scoring_chance_key'] = scoring_chances['event_key']
    scoring_chances['is_goal'] = (scoring_chances['Type'] == 'Goal').astype(int)
    ...
    # Select columns
    cols = ['scoring_chance_key', 'game_id', 'event_index', 'period', 
