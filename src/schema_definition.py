...
SCHEMA = {
    ...
    'dim_rinkboxcoord': [
        'coord_id', 'box_id', 'box_id_rev', 'box_name', 'x_min', 'x_max',
        'y_min', 'y_max', 'x_description', 'y_description', 'zone',
        'side', 'danger', 'is_offensive', 'is_defensive', 'is_neutral'
    ],
    
    'dim_rinkcoordzones': [
        'zone_coord_id', 'box_id', 'box_id_rev', 'zone_name', 'box_name',
        'x_min', 'x_max', 'y_min', 'y_max', 'x_description', 'y_description',
        'zone', 'side', 'depth', 'slot', 'dotside', 'danger', 'center_x', 'center_y'
    ],
...
PRIMARY_KEYS = {
    ...
    'dim_rinkboxcoord': 'coord_id',
    'dim_rinkcoordzones': 'zone_coord_id',
