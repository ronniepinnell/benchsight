        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Expected Goals leaders, Goals Above Expected, and xG trends
            </p>
          </Link>
          <Link
            href="/norad/analytics/trends"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-xs text-muted-foreground">
              League-wide trends and season comparisons
            </p>
          </Link>
          <Link
            href="/norad/analytics/statistics"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Wins Above Replacement and Goals Above Replacement
            </p>
          </Link>
          <Link
            href="/norad/analytics/micro-stats"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-xs text-muted-foreground">
              Detailed player actions and skills breakdown
            </p>
          </Link>
          <Link
            href="/norad/analytics/zone"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-xs text-muted-foreground">
              Zone entry and exit analysis and success rates
            </p>
          </Link>
          <Link
            href="/norad/analytics/rushes"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
              <Zap className="w-5 h-5 text-primary group-hover:scale-110 transition-transform" />
            ...
            <p className="text-xs text-muted-foreground">
              Rush leaders, success rates, and breakaway analysis
            </p>
          </Link>
          <Link
            href="/norad/analytics/faceoffs"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
              <Target className="w-5 h-5 text-primary group-hover:scale-110 transition-transform" />
            ...
            <p className="text-xs text-muted-foreground">
              Faceoff leaders, win percentages, and zone analysis
            </p>
          </Link>
          <Link
            href="/norad/analytics/lines"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-xs text-muted-foreground">
              Line performance, WOWY analysis, and chemistry
            </p>
          </Link>
          <Link
            href="/norad/analytics/shot-chains"
            className="bg-muted/30 rounded-lg p-4 border border-border hover:border-primary/50 transition-colors group"
          >
            <div className="flex items-center gap-3 mb-2">
              <Target className="w-5 h-5 text-primary group-hover:scale-110 transition-transform" />
            ...
            <p className="text-xs text-muted-foreground">
              Shot sequence visualization and pattern analysis
            </p>
          </Link>
        </div>
      </div>
