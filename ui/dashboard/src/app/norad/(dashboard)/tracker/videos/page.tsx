    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button onClick={() => router.push('/norad/tracker')} variant="outline">
            ← Back to Tracker
          </Button>
        </div>
              ...
              <>
                ...
                <div className="border rounded-lg p-4 space-y-3 bg-card">
                  ...
                  <div>
                    ...
                    <SearchableSelect
                      options={[
                        { value: 'youtube', label: 'YouTube', searchText: 'youtube' },
                        { value: 'local', label: 'Local File', searchText: 'local file' },
                        { value: 'other', label: 'Other', searchText: 'other' },
                      ]}
                      value={videoType}
                      onChange={(val) => setVideoType(val as any)}
                    ...
                    <div>
                      ...
                      <SearchableSelect
                        options={[
                          ...
                          { value: '1', label: 'Period 1', searchText: 'period 1' },
                          { value: '2', label: 'Period 2', searchText: 'period 2' },
                          { value: '3', label: 'Period 3', searchText: 'period 3' },
                          { value: '4', label: 'OT', searchText: 'overtime ot' },
                        ]}
                        value={period ? String(period) : ''}
                        onChange={(val) => setPeriod(val ? Number(val) : '')}
                        placeholder="All"
                      />
                    </div>
                    <div>
