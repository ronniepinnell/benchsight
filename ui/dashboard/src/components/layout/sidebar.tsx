...
const navigation: NavSection[] = [
  {
    ...
    icon: '🏒',
    items: [
      { name: 'Recent Games', href: '/games', icon: <Gamepad2 className="w-4 h-4" /> },
      { name: 'Shot Maps', href: '/games/shots', icon: <Target className="w-4 h-4" /> },
    ],
  },
  {
    name: 'League',
    icon: '🏆',
    items: [
      { name: 'Standings', href: '/standings', icon: <BarChart3 className="w-4 h-4" /> },
      { name: 'Leaders', href: '/leaders', icon: <Trophy className="w-4 h-4" /> },
      { name: 'Goalies', href: '/goalies', icon: <Award className="w-4 h-4" /> },
  ...
  },
  {
    ...
    icon: '👥',
    items: [
      { name: 'All Teams', href: '/teams', icon: <Users className="w-4 h-4" /> },
    ],
  },
  {
    name: 'Players',
    icon: '🧑‍🤝‍🧑',
    items: [
      { name: 'Search Players', href: '/players', icon: <User className="w-4 h-4" /> },
      { name: 'Compare', href: '/players/compare', icon: <TrendingUp className="w-4 h-4" /> },
    ],
  },
  {
    name: 'Analytics',
