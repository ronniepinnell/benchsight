-- ============================================================
-- BENCHSIGHT SUPABASE SCHEMA - COMPLETE (36 TABLES)
-- Generated: 2025-12-27
-- ============================================================

-- =====================
-- CORE DIMENSION TABLES (8)
-- =====================
...
CREATE TABLE dim_event_detail (
  event_detail_id int PRIMARY KEY,
  event_detail text,
  event_type text,
  category text,
...
CREATE TABLE dim_play_detail (
  play_detail_id int PRIMARY KEY,
  play_detail text,
  play_category text,
  play_type text,
  description text,
...
CREATE TABLE dim_danger_zone (
  danger_zone_id int PRIMARY KEY,
...
CREATE TABLE dim_time_bucket (
  time_bucket_id int PRIMARY KEY,
  bucket_name text,
...
CREATE TABLE fact_event_players_tracking (
  id serial PRIMARY KEY,
  event_index int,
  player_game_number text,
  player_id text,
...
CREATE TABLE fact_shift_players_tracking (
  id serial PRIMARY KEY,
  shift_index int,
  shift_duration int,
  home_team_plus int,
...
CREATE TABLE fact_linked_events_tracking (
  id serial PRIMARY KEY,
  linked_event_index int,
  first_event int,
  last_event int,
...
CREATE TABLE fact_sequences_tracking (
  id serial PRIMARY KEY,
  sequence_index int,
  first_event int,
  last_event int,
...
CREATE TABLE fact_plays_tracking (
  id serial PRIMARY KEY,
  play_index int,
  first_event int,
  last_event int,
...
CREATE INDEX idx_events_type ON fact_events_tracking(type);
CREATE INDEX idx_events_long_game ON fact_events_long(game_id);
CREATE INDEX idx_event_players_game ON fact_event_players_tracking(game_id);
CREATE INDEX idx_event_players_event ON fact_event_players_tracking(event_index);
CREATE INDEX idx_shifts_game ON fact_shifts_tracking(game_id);
CREATE INDEX idx_shift_players_game ON fact_shift_players_tracking(game_id);
...
CREATE INDEX idx_boxscore_game ON fact_box_score_tracking(game_id);
CREATE INDEX idx_linked_game ON fact_linked_events_tracking(game_id);
CREATE INDEX idx_sequences_game ON fact_sequences_tracking(game_id);
CREATE INDEX idx_plays_game ON fact_plays_tracking(game_id);
...
CREATE INDEX idx_schedule_date ON dim_schedule(date);
CREATE INDEX idx_schedule_home ON dim_schedule(home_team_name);
CREATE INDEX idx_schedule_away ON dim_schedule(away_team_name);
...
ALTER TABLE dim_event_type ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_event_detail ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_play_detail ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_strength ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_situation ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_position ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_zone ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_period ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_venue ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_shot_type ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_pass_type ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_shift_type ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_skill_tier ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_player_role ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_danger_zone ENABLE ROW LEVEL SECURITY;
ALTER TABLE dim_time_bucket ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_gameroster ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_events_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_events_long ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_event_players_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_shifts_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_shift_players_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_playergames ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_box_score_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_linked_events_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_sequences_tracking ENABLE ROW LEVEL SECURITY;
ALTER TABLE fact_plays_tracking ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "Public read" ON dim_event_type FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_event_detail FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_play_detail FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_strength FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_situation FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_position FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_zone FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_period FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_venue FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_shot_type FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_pass_type FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_shift_type FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_skill_tier FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_player_role FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_danger_zone FOR SELECT USING (true);
CREATE POLICY "Public read" ON dim_time_bucket FOR SELECT USING (true);
...
CREATE POLICY "Public read" ON fact_events_long FOR SELECT USING (true);
CREATE POLICY "Public read" ON fact_event_players_tracking FOR SELECT USING (true);
CREATE POLICY "Public read" ON fact_shifts_tracking FOR SELECT USING (true);
CREATE POLICY "Public read" ON fact_shift_players_tracking FOR SELECT USING (true);
...
CREATE POLICY "Public read" ON fact_linked_events_tracking FOR SELECT USING (true);
CREATE POLICY "Public read" ON fact_sequences_tracking FOR SELECT USING (true);
CREATE POLICY "Public read" ON fact_plays_tracking FOR SELECT USING (true);
CREATE POLICY "Public read" ON fact_event_coordinates FOR SELECT USING (true);

-- Public write for tracker tables
...
CREATE POLICY "Public delete" ON fact_events_tracking FOR DELETE USING (true);
CREATE POLICY "Public insert" ON fact_events_long FOR INSERT WITH CHECK (true);
CREATE POLICY "Public update" ON fact_events_long FOR UPDATE USING (true);
CREATE POLICY "Public delete" ON fact_events_long FOR DELETE USING (true);
...
CREATE POLICY "Public delete" ON fact_shifts_tracking FOR DELETE USING (true);
CREATE POLICY "Public insert" ON fact_shift_players_tracking FOR INSERT WITH CHECK (true);
CREATE POLICY "Public update" ON fact_shift_players_tracking FOR UPDATE USING (true);
CREATE POLICY "Public delete" ON fact_shift_players_tracking FOR DELETE USING (true);
...
CREATE POLICY "Public delete" ON fact_event_coordinates FOR DELETE USING (true);
CREATE POLICY "Public insert" ON fact_event_players_tracking FOR INSERT WITH CHECK (true);
CREATE POLICY "Public update" ON fact_event_players_tracking FOR UPDATE USING (true);
CREATE POLICY "Public delete" ON fact_event_players_tracking FOR DELETE USING (true);
