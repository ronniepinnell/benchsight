...
-- Auto-generated with proper column quoting and deduplication
-- ============================================================
--
-- Run this in Supabase SQL Editor to create all tables.
-- Column names with uppercase, numbers, or reserved words are quoted.
-- ============================================================
...
CREATE INDEX idx_fact_cycle_events_game_id ON fact_cycle_events(game_id);
...
CREATE INDEX idx_fact_game_status_game_id ON fact_game_status(game_id);
...
CREATE INDEX idx_fact_gameroster_game_id ON fact_gameroster(game_id);
...
CREATE INDEX idx_fact_head_to_head_game_id ON fact_head_to_head(game_id);
...
CREATE INDEX idx_fact_league_leaders_snapshot_game_id ON fact_league_leaders_snapshot(game_id);
...
CREATE INDEX idx_fact_matchup_summary_game_id ON fact_matchup_summary(game_id);
...
CREATE INDEX idx_fact_player_boxscore_all_game_id ON fact_player_boxscore_all(game_id);
...
CREATE INDEX idx_fact_player_pair_stats_game_id ON fact_player_pair_stats(game_id);
...
CREATE INDEX idx_fact_rush_events_game_id ON fact_rush_events(game_id);
...
CREATE INDEX idx_fact_suspicious_stats_game_id ON fact_suspicious_stats(game_id);
...
CREATE INDEX idx_fact_team_standings_snapshot_game_id ON fact_team_standings_snapshot(game_id);
...
CREATE INDEX idx_qa_suspicious_stats_game_id ON qa_suspicious_stats(game_id);