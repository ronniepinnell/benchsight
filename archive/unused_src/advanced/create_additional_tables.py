...
def create_fact_player_stats_long():
    ...
    save_output_table(df, 'fact_player_stats_long', OUTPUT_DIR)
...
def create_fact_team_game_stats_enhanced():
    ...
    save_output_table(team_stats, 'fact_team_game_stats', OUTPUT_DIR)
...
def create_fact_line_combos_enhanced():
    ...
    save_output_table(line_combos, 'fact_line_combos', OUTPUT_DIR)
...
def create_fact_matchup_summary():
    ...
    save_output_table(matchup, 'fact_matchup_summary', OUTPUT_DIR)
...
def create_fact_shift_quality():
    ...
    df = pd.DataFrame(records)
    save_output_table(df, 'fact_shift_quality', OUTPUT_DIR)
...
def create_fact_zone_time_enhanced():
    ...
    save_output_table(zone_time, 'fact_team_zone_time', OUTPUT_DIR)
...
def create_fact_scoring_chances():
    ...
    save_output_table(scoring_chances, 'fact_scoring_chances', OUTPUT_DIR)
...
def create_dim_stat_category():
    ...
    save_output_table(df, 'dim_stat_category', OUTPUT_DIR)
...
def create_dim_micro_stat():
    ...
    save_output_table(df, 'dim_micro_stat', OUTPUT_DIR)
...
def create_fact_player_micro_stats():
    ...
    df = pd.DataFrame(records)
    save_output_table(df, 'fact_player_micro_stats', OUTPUT_DIR)
